...
pub fn get_url(bid: &str) -> String {
    ...
    if let Some(e) = blacklist::entry_by_id(bid) {
        ...
        let kind = if id.starts_with("B3") {
            ...
            if matches!(id.as_str(), "B313" | "B314" | "B315" | "B316" | "B317" | "B318" | "B319" | "B320") {
...
mod tests {
    ...
    fn urls() {
        ...
        assert_eq!(get_url("B304"), format!("{base}blacklists/blacklist_calls.html#b304-b305-ciphers-and-modes"));
        assert_eq!(get_url("B101"), format!("{base}plugins/b101_assert_used.html"));
        assert_eq!(get_url("B413"), format!("{base}blacklists/blacklist_imports.html#b413-import-pycrypto"));
        assert_eq!(get_url("B324"), format!("{base}plugins/b324_hashlib.html"));
        assert_eq!(get_url("B313"), format!("{base}blacklists/blacklist_calls.html#b313-b320-xml-bad-celementtree"));
